...
enum
{
	...
	BLOCK_VERSION_BLAKE      = (3 << 9),
    BLOCK_VERSION_SKEIN      = (4 << 9),
    BLOCK_VERSION_QUBIT      = (5 << 9),
...
// Aiden aux chain ID = 0x009B (155)
static const int AUXPOW_CHAIN_ID = 0x0085;
static const int AUXPOW_START_MAINNET = 837000; //TODO change me
