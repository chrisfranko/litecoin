...
std::string HelpMessage(HelpMessageMode hmm)
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: aiden.conf)") + "\n";
    if (hmm == HMM_BITCOIND)
    {
#if !defined(WIN32)
    ...
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: aiden.pid)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Algo
    std::string strAlgo = GetArg("-algo", "scrypt-og");
    transform(strAlgo.begin(),strAlgo.end(),strAlgo.begin(),::tolower);
	if (strAlgo == "scrypt-og")
        miningAlgo = ALGO_SCRYPT_OG;
	else if (strAlgo == "scrypt" || strAlgo == "nfactor10")
...
#endif
    // Make sure only a single Aiden process is using the data directory.
