...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Aiden Core aiden-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  aiden-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded aiden transaction") + "\n" +
              "  aiden-tx [options] -create [commands]   " + _("Create hex-encoded aiden transaction") + "\n" +
              "\n";
